...
This is the core biz-email library, composed by the following parts
...
```sh
$ npm install --save biz-email-core
```

or

```sh
$ yarn add biz-email-core
```

## transform mjml to json

```ts
import { MjmlToJson } from "biz-email-core";
